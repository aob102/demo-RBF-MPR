...
${VoirDossier}   //li[@id='$PD_pyMyCasesTree$ppxResults$l3']//button[@data-test-id='20191011113919010615759']                                  # PENSER A CHANGER L'ORDRE DE DOSSIER : IMPACTE VARIABLE SUIVANTE
${loc-NumDossier}    //*[@id="$PD_pyMyCasesTree$ppxResults$l3"]//div[@data-test-id='2019100915472206281040439' and contains(text(),'MPR')]     # PENSER A CHANGER L'ORDRE DE DOSSIER : VARAIABLE IMPACTE
*** Keywords ***
